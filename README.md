...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-07 08:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b9e94228-57a0-4b17-8bb0-c159e386f14a.git
$ cd b9e94228-57a0-4b17-8bb0-c159e386f14a
```
